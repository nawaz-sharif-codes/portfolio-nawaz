...
export const CASE_STUDIES: Record<string, CaseStudy> = {
  'identity-migration': {
    ...
    approach: [
      ...
      'Built a resumable, checkpointed extraction pipeline in TypeScript to pull the full ~1.4 million-user managed identity dataset — using cookie-based pagination with token refresh so the extraction can survive interruptions without starting over',
